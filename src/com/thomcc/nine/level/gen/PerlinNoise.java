...
public class PerlinNoise {
 ...
 public static void main(String args[]) {
   ...
   for (int j = 0; j < 500; ++j) {
     for (int i = 0; i < 500; ++i) {
       double n = PerlinNoise.noise(i/75.0, j/75.0, z/75.0);
       //n = (n+1)/2;
       n = Math.abs(n);
       int v = (int)(n*255.0);
       if (v < 1) v = 128;
   ...
   JOptionPane.showMessageDialog(
       ...
       new ImageIcon(im.getScaledInstance(im.getWidth(),
           im.getHeight(), Image.SCALE_AREA_AVERAGING)));
 }
}
